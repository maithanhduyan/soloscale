...
sudo chmod -R 755 ./odoo/web-data ./odoo/log ./odoo/addons ./odoo/conf
...
# chmod -R 755 web-data log addons conf
...
# sudo chmod -R 775 
#  docker compose -f '/home/soloscale/services/odoo/docker-compose.yml' down 
#  docker compose -f 'soloscale/services/odoo/docker-compose.yml' up -d --build
# docker compose -f 'soloscale/services/odoo/docker-compose.yml' restart odoo_18
# docker compose -f 'soloscale/services/odoo/docker-compose.yml' restart 